      ...
      <section className="relative py-20 px-4 overflow-hidden" style={{backgroundColor: '#F2F0E8'}}>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <svg className="absolute inset-0 w-full h-full opacity-8 animate-waveFlow" viewBox="0 0 1800 400" style={{animationDuration: '18s'}}>
            ...
            <path d="M0,200 Q300,100 600,200 T1200,200 T1800,200" stroke="url(#timelineBgGradient1)" strokeWidth="2" fill="none"/>
            <path d="M0,150 Q250,250 500,150 T1000,150 T1500,150" stroke="url(#timelineBgGradient2)" strokeWidth="1.5" fill="none"/>
            <path d="M0,300 Q400,200 800,300 T1600,300" stroke="url(#timelineBgGradient1)" strokeWidth="1.2" fill="none" opacity="0.8"/>
          </svg>
        </div>
