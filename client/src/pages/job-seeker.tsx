...
export default function JobSeekerPage() {
  ...
  return (
    <div className="min-h-screen page-transition">
      ...
      <section className="relative py-1 sm:py-4 md:py-8 lg:py-12 cream overflow-hidden">
                ...
                <div key={testimonial.id} className="testimonial-slide" data-slide={index}>
                  <Card className="testimonial-card bg-white p-6 rounded-3xl border-0 shadow-lg w-[350px] h-[400px]">
                    <CardContent className="p-0 h-full flex flex-col">
                      ...
                      <blockquote className="text-gray-700 mb-3 italic text-xs leading-relaxed flex-1 overflow-hidden">
                      ...
                      <div className="text-xs mt-auto">
                        ...
                        <div className="text-gray-500 text-xs leading-tight">{testimonial.location}</div>
                      </div>
                    </CardContent>
                  </Card>
                </div>
