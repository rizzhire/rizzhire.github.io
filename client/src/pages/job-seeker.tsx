          ...
          <div className="text-center space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                <DialogContent className="max-w-none w-[95vw] sm:w-[90vw] md:w-[80vw] lg:w-[60vw] xl:w-[50vw] max-h-[90vh] p-0 border-none shadow-2xl overflow-hidden" style={{ borderRadius: '40px', backgroundColor: 'rgba(255, 255, 255, 0.95)' }}>
