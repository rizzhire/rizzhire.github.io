...
export default function JobSeekerPage() {
  ...
  return (
    <div className="min-h-screen page-transition">
      ...
      <section className="relative py-16 cream overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <svg className="absolute inset-0 w-full h-full opacity-8 animate-waveFlow" viewBox="0 0 1000 600">
            <defs>
              <linearGradient id="jobSeekerCertificateGradient1" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#f59e0b" stopOpacity="0.15"/>
                <stop offset="100%" stopColor="#f59e0b" stopOpacity="0"/>
              </linearGradient>
            </defs>
            <path d="M0,300 Q250,100 500,300 T1000,300" stroke="url(#jobSeekerCertificateGradient1)" strokeWidth="2" fill="none"/>
            <path d="M0,200 Q300,400 600,200 T1000,200" stroke="url(#jobSeekerCertificateGradient1)" strokeWidth="1.5" fill="none"/>
          </svg>
          
          {/* Wavy Abstract Traveling Lines */}
          <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 1000 600">
            <defs>
              <linearGradient id="jobSeekerCertificateWavy1" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#f59e0b" stopOpacity="0"/>
                <stop offset="50%" stopColor="#f59e0b" stopOpacity="0.15"/>
                <stop offset="100%" stopColor="#f59e0b" stopOpacity="0"/>
              </linearGradient>
              <linearGradient id="jobSeekerCertificateWavy2" x1="0%" y1="100%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#3b82f6" stopOpacity="0"/>
                <stop offset="50%" stopColor="#3b82f6" stopOpacity="0.12"/>
                <stop offset="100%" stopColor="#3b82f6" stopOpacity="0"/>
              </linearGradient>
              <linearGradient id="jobSeekerCertificateWavy3" x1="100%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" stopColor="#8b5cf6" stopOpacity="0"/>
                <stop offset="50%" stopColor="#8b5cf6" stopOpacity="0.13"/>
                <stop offset="100%" stopColor="#8b5cf6" stopOpacity="0"/>
              </linearGradient>
              <linearGradient id="jobSeekerCertificateWavy4" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop offset="0%" stopColor="#f97316" stopOpacity="0"/>
                <stop offset="50%" stopColor="#f97316" stopOpacity="0.11"/>
                <stop offset="100%" stopColor="#f97316" stopOpacity="0"/>
              </linearGradient>
            ...
            <path 
              d="M-150,100 C-50,90 100,120 350,110 C600,105 800,95 950,92 C1050,90 1100,88 1150,90" 
              stroke="url(#jobSeekerCertificateWavy1)" 
              strokeWidth="1.5" 
              fill="none"
              className="animate-wavyTravel1"
              style={{animationDelay: '1s'}}
            ...
            <path 
              d="M1150,200 C1050,210 900,170 650,180 C400,185 250,205 100,208 C0,210 -50,211 -150,210" 
              stroke="url(#jobSeekerCertificateWavy2)" 
              strokeWidth="1.2" 
              fill="none"
              className="animate-wavyTravel2"
              style={{animationDelay: '3s'}}
            ...
            <path 
              ...
              stroke="url(#jobSeekerCertificateWavy3)" 
              strokeWidth="1.0" 
              fill="none"
              className="animate-wavyTravel1"
              style={{animationDelay: '5s'}}
            ...
            <path 
              ...
              stroke="url(#jobSeekerCertificateWavy4)" 
              strokeWidth="0.8" 
              fill="none"
              className="animate-wavyTravel2"
              style={{animationDelay: '7s'}}
          ...
          <svg className="absolute inset-0 w-full h-full opacity-6" viewBox="0 0 1000 600">
            <defs>
              <radialGradient id="jobSeekerCertificateDotGradient" cx="50%" cy="50%" r="3">
                <stop offset="0%" stopColor="#f59e0b" stopOpacity="0.4"/>
                <stop offset="100%" stopColor="#f59e0b" stopOpacity="0"/>
              </radialGradient>
            </defs>
            <circle cx="150" cy="120" r="2" fill="url(#jobSeekerCertificateDotGradient)" className="animate-pulseEnhanced" style={{animationDelay: '2s'}}/>
            <circle cx="300" cy="180" r="1.5" fill="url(#jobSeekerCertificateDotGradient)" className="animate-pulseEnhanced" style={{animationDelay: '4s'}}/>
            <circle cx="650" cy="140" r="2.5" fill="url(#jobSeekerCertificateDotGradient)" className="animate-pulseEnhanced" style={{animationDelay: '1s'}}/>
            <circle cx="800" cy="220" r="2" fill="url(#jobSeekerCertificateDotGradient)" className="animate-pulseEnhanced" style={{animationDelay: '3s'}}/>
            <circle cx="450" cy="320" r="1.8" fill="url(#jobSeekerCertificateDotGradient)" className="animate-pulseEnhanced" style={{animationDelay: '5s'}}/>
            <circle cx="200" cy="400" r="2.2" fill="url(#jobSeekerCertificateDotGradient)" className="animate-pulseEnhanced" style={{animationDelay: '6s'}}/>
            <circle cx="750" cy="380" r="1.6" fill="url(#jobSeekerCertificateDotGradient)" className="animate-pulseEnhanced" style={{animationDelay: '2.5s'}}/>
            <circle cx="550" cy="480" r="2.3" fill="url(#jobSeekerCertificateDotGradient)" className="animate-pulseEnhanced" style={{animationDelay: '4.5s'}}/>
          </svg>
        </div>
        <div 
