    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black navbar-slide-down">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex justify-between items-center h-16">
          ...
          <div>
            <Button 
              ...
              className="bg-yellow text-black px-6 py-2 rounded-full font-medium hover:bg-yellow/90 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-yellow/20 transform active:scale-95 border border-white/20"
            >
        ...
        <div className="md:hidden flex justify-between items-center h-16">
          ...
          {/* Center: Logo */}
          <div className="text-white font-bold text-xl absolute left-1/2 transform -translate-x-1/2">
            HireNET
          </div>
          ...
          <Button 
            onClick={location === '/job-seeker' ? navigateHome : navigateToJobSeeker}
            className="bg-yellow text-black px-2 py-1 rounded-full font-medium hover:bg-yellow/90 transition-all duration-300 text-xs border border-white/20"
          >
            {location === '/job-seeker' ? 'For Employers' : 'For Job Seeker'}
          </Button>
        </div>
