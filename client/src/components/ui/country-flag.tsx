...
export default function CountryFlag({ country, code }: CountryFlagProps) {
  const baseClass = "w-20 h-14 rounded-2xl border border-white/20 cursor-pointer hover:scale-105 transition-transform duration-200 relative overflow-hidden" 
